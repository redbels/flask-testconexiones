document.addEventListener("DOMContentLoaded", function () {
  ...
  // 🔹 Mapeo de puntuación para TODAS las 20 preguntas
  const scoreMapping = {
    "Todos los días con interés.": 3, "Me responde, pero a veces tarda mucho.": 2,
    "Solo me habla cuando yo escribo primero.": 1, "Aparece y desaparece sin lógica.": 0,

    "Sí, le interesa hablar conmigo.": 3, "A veces sí, a veces no.": 2,
    "No, siempre tengo que escribir primero.": 1,

    "Responde rápido y con interés.": 3, "A veces responde al instante, a veces tarda horas o días.": 2,
    "Siempre deja los mensajes en visto por horas/días sin motivo.": 1,

    "Nunca, siempre mantiene el contacto.": 3, "Alguna vez, pero lo hablamos.": 2,
    "Sí, varias veces, y cuando vuelve actúa como si nada.": 1,

    "Sí, se planifica y los propone.": 3, "A veces, pero no con tanta iniciativa.": 2,
    "No, siempre los propongo yo.": 1,

    "Se muestra interesado.": 3, "Responde normal, sin mucho interés.": 2,
    "Evita la conversación o cambia de tema.": 1,

    "Los organiza con tiempo y los cumple.": 3, "Los propone, pero a veces los cancelan.": 2,
    "Siempre son improvisados, nunca se compromete a nada.": 1,

    "Sí, claramente.": 3, "No lo tengo claro, a veces sí a veces no.": 2,
    "No, siempre soy su último plan.": 1,

    "Sí, me cuenta cosas importantes de su vida.": 3, "A veces, pero no demasiado.": 2,
    "No, evita esos temas o cambia la conversación.": 1,

    "Sí, me presta atención real.": 3, "A veces, pero hay momentos en que se distancia.": 2,
    "No, siento que soy un pasatiempo más.": 1,

    "No, siempre fue claro/a conmigo.": 3, "Fue muy ambiguo.": 2,
    "Sí, varias veces.": 1,

    "No, siempre fue claro/a.": 3, "A veces sí, pero en general nos llevamos bien.": 2,
    "Sí, me da señales mixtas todo el tiempo.": 1,

    "Sí, lo que dice y lo que hace están alineados.": 3, "A veces, pero noto contradicciones.": 2,
    "No, dice una cosa y hace otra.": 1,

    "No, respeta mi vida personal.": 3, "A veces muestra interés o curiosidad.": 2,
    "Sí, pero después desaparece como si nada.": 1,

    "Me siento seguro/a, hay estabilidad.": 3, "A veces bien, a veces mal, no es claro.": 2,
    "Siento que me genera ansiedad constante.": 1,

    "Muestra interés y busca saber qué pasa.": 3, "A veces lo nota, a veces no.": 2,
    "No se da cuenta o le da lo mismo.": 1,

    "No, habla del tema sin problemas.": 3, "A veces parece incómodo.": 2,
    "Sí, evita el tema o se pone a la defensiva.": 1,

    "Sí, y estamos en la misma página.": 3, "Sí, pero no sé si estamos alineados.": 2,
    "No, nunca lo hablamos.": 1,

    "Me escucha y busca entenderme.": 3, "Me escucha, pero no veo cambios.": 2,
    "Si lo toma mal o lo evita.": 1,

    "No, sigue igual o incluso más interesado/a.": 3, "Sí, siento que está más frío/a ahora.": 2,
