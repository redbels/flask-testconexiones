...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Preguntas (todas las 20 preguntas completas)
    const questions = [
        { question: "1️⃣ 📱 ¿Con qué frecuencia te escribe?", options: [
        ...
        { question: "5️⃣ 🏃‍♂️ ¿Hace planes para verte?", options: [
        ...
        { question: "9️⃣ ❤️ ¿Hablan de cosas personales y profundas?", options: [
