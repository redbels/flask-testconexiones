document.addEventListener("DOMContentLoaded", function () {
  ...
  const questions = [
    ...
    {
      question: "3️⃣ ⌛ ¿Cuánto tarda en responderte?",
      options: [
    ...
    {
      question: "4️⃣ 📵 ¿Alguna vez dejó de responder sin explicación y después apareció como si nada?",
      options: [
    ...
    {
      question: "6️⃣ 📍 ¿Cómo son sus respuestas cuando hablás acerca de tu vida?",
      options: [
    ...
    {
      question: "7️⃣ 🗓️ ¿Cómo son sus planes con vos?",
      options: [
    ...
    {
      question: "8️⃣ 😌 ¿Sentís que te da prioridad en tu vida?",
      options: [
        "Sí, claramente.",
        "No lo tengo claro, a veces sí ya veces no.",
        "No, siempre soy su último plan."
      ]
    },
    // BLOQUE 3: Conexión Emocional
    {
      question: "📌 BLOQUE 3: Conexión Emocional\n9️⃣ ❤️ ¿Hablan de cosas personales y profundas?",
      options: [
    ...
    {
      question: "🔟 😏 ¿Te hace sentir especial cuando están juntos?",
      options: [
    ...
    {
      question: "1️⃣1️⃣ 🤔 ¿Alguna vez te dijo que no está seguro de lo que siente por vos?",
      options: [
    ...
    {
      question: "1️⃣2️⃣ 💭 ¿Alguna vez te dio señales confusas sobre lo que quieres con vos?",
      options: [
    ...
    {
      question: "📌 BLOQUE 4: Actitud y Coherencia\n1️⃣3️⃣ 🎭 ¿Sus palabras y acciones coinciden?",
      options: [
    ...
    {
      question: "1️⃣4️⃣ 🔄 ¿Siente celos o te ha hecho comentarios sobre otras personas con las que salís?",
      options: [
    ...
    {
      question: "1️⃣5️⃣  ¿Alguna vez lo notaste incómodo/a cuando se habla de relaciones o compromiso?",
      options: [
    ...
    {
      question: "1️⃣6️⃣ 💬 ¿Hablaron sobre qué buscan en una relación?",
      options: [
    ...
    {
      question: "📌 BLOQUE 5: Dinámica General\n1️⃣7️⃣ 👀 ¿Cómo actúa cuando le hablás de lo que necesitás en la relación?",
      options: [
    ...
    {
      question: "1️⃣8️⃣ 📉 ¿Sientes que su nivel de interés cambió con el tiempo?",
      options: [
        "No, sigue igual o incluso más interesado/a.",
        "Sí, siento que está más frío/a ahora.",
        "Sí, al principio era atento/ay ahora apenas responde."
      ]
    },
    {
      question: "1️⃣9️⃣ 🎢 ¿Te sentiste seguro/a con esta relación o es una montaña rusa emocional?",
      options: [
    ...
    {
      question: "2️⃣0️⃣ 🚪 Si te alejás, ¿cómo reacciona?",
      options: [
  ...
  function loadQuestions() {
    ...
    for (let i = currentQuestionIndex; i < blockEnd; i++) {
      ...
      // Si el texto de la pregunta contiene el título del bloque, separamos el bloque y la pregunta
      if (q.question.includes("\n")) {
        const parts = q.question.split("\n");
        // Primer parte: título del bloque
        const blockTitle = document.createElement("h3");
        blockTitle.textContent = parts[0];
        questionDiv.appendChild(blockTitle);
        // Espacio entre el título y la pregunta
        questionDiv.appendChild(document.createElement("br"));
        // Segunda parte: la pregunta
      ...
      q.options.forEach(option => {
        ...
        button.onclick = function () {
          saveAnswer(i, option);
          // Quitar la clase 'selected' de todos los botones de esta pregunta
